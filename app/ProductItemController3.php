    ...
    public function makePayment(Request $request)
    {
       ...
       if($request->payment_method=="Cash")
       {
        ...
        if($recType=="Collect"){
                ...
                $newHtmlStr.='<tr><td></td><td></td><td></td><td align="right" style="font-size:20px;">GBP</td></tr>
                '.$newReceiptProduct;
                $newHtmlStr.='<tr><td colspan="3" style="font-size:20px;">Sub Total</td><td align="right" style="font-size:16px;">'.number_format($receiptTotal,2).'</td></tr>';
                    if($tax_amount>0)
                    {
                    ...
                    if($discount_amount>0)
                    {
                        $newHtmlStr .='<tr><td colspan="3" style="font-size:20px;">'.$discount_title.'</td><td align="right" style="font-size:20px;">'.number_format($discount_amount,2).'</td></tr>';
                    }


                $newHtmlStr.='<tr><td colspan="3"></td><td><hr /></td></tr>
                    <tr><td colspan="3" style="font-size:25px;">Total Due</td><td style="font-size:20px;" align="right">'.number_format($receiptTotaldue,2).'</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>
                ...
                {
                    $newHtmlStr.='<tr><td colspan="4" align="center" style="font-size:25px; text-transform: uppercase; font-weight: 600;">New Customer</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
                }else{
                ...
                $newHtmlStr='
                    ...
                    <tr><td colspan="4" align="center">'.$ct->contact_address.'</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>
                    <tr><td colspan="4" align="center" style="font-size:30px;">Order No:<b>'.$order_id.'</b></td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>
                    <tr><td colspan="4" align="center" style="font-size:30px;"><b>'.$autoOrderType.'</b></td></tr>';
                ...
                $newHtmlStr.='<tr><td colspan="3" style="font-size:20px;">Sub Total</td><td align="right" style="font-size:20px;">'.number_format($receiptTotal,2).'</td></tr>';
                if($tax_amount>0)
                {
                  $newHtmlStr .='<tr><td colspan="3" style="font-size:20px;">'.$tax_title.'</td><td align="right" style="font-size:20px;">'.number_format($tax_amount,2).'</td></tr>';
                }
...
/*	  $this->sdc->PrinterinitMail("printordergt90@bombaynite.com",
        ...
        if($recType=="Collect"){
                ...
                if($cart->deliveryDetail['asap']==2){
                    $newHtmlStr .='<tr><td colspan="4" align="center" style="font-size:20px;">Due '.date('d-M',strtotime($cart->deliveryDetail['delivery_date'])).' at '.$cart->deliveryDetail['delivery_time'].'</td></tr>';
                }elseif($cart->deliveryDetail['asap']==1){
                    $newHtmlStr .='<tr><td colspan="4" align="center" style="font-size:20px;">Due '.date('d-M').' at <b>ASAP</b></td></tr>';
                }
                ...
                if($totalCustomerOrder==1)
                {
                    ...
                    $newHtmlStr.='<tr><td colspan="4" align="center" style="font-size:25px; text-transform: uppercase; font-weight: 600;">Old Customer</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
                }
