...
*/
    ...
    public $nochex_merchant_id="";
    public $paypal_client_id="";
    public $paypal_secret="";
//'fakhrulislamtalukder@gmail.com'
    public function __construct(){ 
        ...
        //$this->ContactAdminEmail='fakhrulislamtalukder@gmail.com';
        $dataSit=Seo::find(1);
...
*/
     public static function TableUserOrder($name='',$sitename='The Bombay Cottage')
    {
        return "Dear ".$name.", Thank you for ordering food at ".$sitename.". </br><strong> Excellent offer:</strong></br><strong> • GET 20% DISCOUNT to your next takeaway meal when order online to collect</strong></br><strong> • FREE ONE BOTTLES OF BEERS when your order more than £35 after discount</strong></br> <strong> • 40% DISCOUNT (on food) when eat inside. Monday to Wednesday</strong></br> <strong> • 40% OFF ON DRINKS ON SUNDAY from 1.00pm to 5.00pm </strong></br>You need to show this to claim promotional offer. This offer is not valid on bank and any festive holiday. Management can discontinue this offer without any notice</br> We have included your order receipt and details below:";
    }
    ...
    {
        return "Dear ".$name.", Thank you for table reservation at South Cemetery, ".$sitename.". We have included your Reservation details below:";
    }
    ...
    )
    {
          ...
          try {
              ...
              $mail->SMTPAuth = true;
              $mail->Username = 'noreply@cemetery.corianderrestaurants.co.uk';
              $mail->Password = 'T]LxMDF;2glK';
...
/*
              ...
              $mail->setFrom('noreply@cemetery.corianderrestaurants.co.uk', $this->SiteName);
              //$mail->addReplyTo('noreply@bombaynite.com', 'No-Reply - Bombay Nite');
