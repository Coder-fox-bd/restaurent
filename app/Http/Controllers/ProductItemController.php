...
class ProductItemController extends Controller
{
    ...
    private $_developer_ip="103.57.42.222";
    public function __construct(){ 
        ...
        {
            $paypal_conf=\Config::get('paypal_sandbox');
    ...
    public function makePayment(Request $request)
    {
       ...
       // dd($defultReturn['cart']->items);
        ...
        $siteMessage='<h2><strong><span style="color: #ff9900;">Receipt</span></strong></h2>
                        ...
                        <tr>
                        <td style="width: 184px; height: 36px; font-size:20px;">Order ID</td>
                        <td style="font-size:20px;"><b>&nbsp;'.$order_id.'</b></td>
                        </tr>
                        <tr>
        ...
        if($request->payment_method=="Cash")
        {
          ...
          elseif($request->payment_method=="Nochex")
        {
            $siteMessage .='<tr style="height: 18px;">
                                <td style="width: 184px; height: 18px;">&nbsp;Payment Type&nbsp;</td>
                                <td style="width: 244px; height: 18px;"><h2>NOCHEX</h2></td>
                            </tr>
                            <tr style="height: 18px;">
       ...
       if($request->payment_method=="Cash")
       {
        ...
        $newReceiptProduct .='<tr>
                                    <td valign="top" style="font-size:26px;">'.intval($itm->quantity).'</td>
                                    <td valign="top" align="center" style="font-size:26px;">X</td>
                                    <td valign="top" width="300" style="font-size:20px;"><b>'.$proNameFromRow.'</b></td>
                                    <td valign="top" align="right" style="font-size:22px;">'.number_format($itm->row_total,2).'</td>
                            </tr>
                            <tr>
        ...
        if($recType=="Collect"){
                ...
                <table border="0" align="center" width="300">
                    <tr><td colspan="4" align="center" style="font-size:40px;"><b>'.$ct->contact_title.'</b></td></tr>
                    <tr><td colspan="4" align="center"><b>Tel : '.$ct->contact_phone.'</b></td></tr>
                    <tr><td colspan="4" align="center">'.$ct->contact_address.'</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>
                    <tr><td colspan="4" align="center" style="font-size:40px;">Order No:<b>'.$order_id.'</b></td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>
                    <tr><td colspan="4" align="center" style="font-size:40px;"><b>'.$autoOrderType.'</b></td></tr>';


                if($cart->deliveryDetail['asap']==2){
                    $newHtmlStr .='<tr><td colspan="4" align="center" style="font-size:40px;">Due '.date('d-M',strtotime($cart->deliveryDetail['delivery_date'])).' at '.$cart->deliveryDetail['delivery_time'].'</td></tr>';
                }elseif($cart->deliveryDetail['asap']==1){
                    $newHtmlStr .='<tr><td colspan="4" align="center" style="font-size:40px;">Due '.date('d-M').' at <b>ASAP</b></td></tr>';
                }
                ...
                if(!empty($pro->delivery_note))
                {
                    ...
                    <tr><td colspan="4" align="left" style="font-size:40px;">'.$pro->delivery_note.'</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
                }

            

                $newHtmlStr.='<tr><td></td><td></td><td></td><td align="right" style="font-size:40px;">GBP</td></tr>
                '.$newReceiptProduct;
                $newHtmlStr.='<tr><td colspan="3" style="font-size:30px;">Sub Total</td><td align="right" style="font-size:35px;">'.number_format($receiptTotal,2).'</td></tr>';
                    if($tax_amount>0)
                    {

                      $newHtmlStr .='<tr><td colspan="3" style="font-size:30px;">'.$tax_title.'</td><td align="right" style="font-size:30px;">'.number_format($tax_amount,2).'</td></tr>';

                    }

                    if($discount_amount>0)
                    {
                        $newHtmlStr .='<tr><td colspan="3" style="font-size:30px;">'.$discount_title.'</td><td align="right" style="font-size:30px;">'.number_format($discount_amount,2).'</td></tr>';
                    }


                $newHtmlStr.='<tr><td colspan="3"></td><td><hr /></td></tr>
                    <tr><td colspan="3" style="font-size:35px;">Total Due</td><td style="font-size:35px;" align="right">'.number_format($receiptTotaldue,2).'</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>
                    <tr><td colspan="4" align="center" style="font-size:40px; font-weight: bolder; text-transform: uppercase;">Order Not Paid</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';

                $newHtmlStr.='<tr><td colspan="4" align="left"><b>Customer Detail</b></td></tr>
                    <tr><td colspan="4" align="left" style="font-size:45px;">Name : '.$delivery->first_name.'</td></tr>
                    <tr><td colspan="4" align="left">&nbsp;</td></tr>
                    <tr><td colspan="4" align="left">Customer Number:</td></tr>
                    <tr><td colspan="4" align="left" style="font-size:45px;"><b>'.$delivery->mobile_phone.'</b></td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
                
                if($totalCustomerOrder==1)
                {
                    $newHtmlStr.='<tr><td colspan="4" align="center" style="font-size:40px; text-transform: uppercase; font-weight: 600;">New Customer</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
                }else{
                    $newHtmlStr.='<tr><td colspan="4" align="center" style="font-size:40px; text-transform: uppercase; font-weight: 600;">Existing Customer</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
                }
                ...
                $newHtmlStr='
                    <table border="0" align="center" width="300">
                    <tr><td colspan="4" align="center" style="font-size:35px;"><b>'.$ct->contact_title.'</b></td></tr>
                    <tr><td colspan="4" align="center"><b>Tel : '.$ct->contact_phone.'</b></td></tr>
                    <tr><td colspan="4" align="center">'.$ct->contact_address.'</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>
                    <tr><td colspan="4" align="center" style="font-size:42px;">Order No:<b>'.$order_id.'</b></td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>
                    <tr><td colspan="4" align="center" style="font-size:42px;"><b>'.$autoOrderType.'</b></td></tr>';

                if($cart->deliveryDetail['asap']==2){
                    $newHtmlStr .='<tr><td colspan="4" align="center" style="font-size:32px;">Due '.date('d-M',strtotime($cart->deliveryDetail['delivery_date'])).' at '.$cart->deliveryDetail['delivery_time'].'</td></tr>';
                }elseif($cart->deliveryDetail['asap']==1){
                    $newHtmlStr .='<tr><td colspan="4" align="center" style="font-size:32px;">Due '.date('d-M').' at <b>ASAP</b></td></tr>';
                }
                ...
                {
                    $newHtmlStr.='<tr><td colspan="4" align="left"><b>Restaurants Notes</b></td></tr>
                    <tr><td colspan="4" align="left" style="font-size:35px;">'.$pro->delivery_note.'</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
                }


                $newHtmlStr.='<tr><td></td><td></td><td></td><td align="right" style="font-size:35px;">GBP</td></tr>
                '.$newReceiptProduct;

                $newHtmlStr.='<tr><td colspan="3" style="font-size:35px;">Sub Total</td><td align="right" style="font-size:35px;">'.number_format($receiptTotal,2).'</td></tr>';
                if($tax_amount>0)
                {
                  $newHtmlStr .='<tr><td colspan="3" style="font-size:35px;">'.$tax_title.'</td><td align="right" style="font-size:35px;">'.number_format($tax_amount,2).'</td></tr>';
                }

                if($discount_amount>0)
                {
                    $newHtmlStr .='<tr><td colspan="3" style="font-size:35px;">'.$discount_title.'</td><td align="right" style="font-size:25px;">'.number_format($discount_amount,2).'</td></tr>';
                }

                if($extra_cost_in_delivery>0)
                {
                    $newHtmlStr .='<tr><td colspan="3" style="font-size:30px;">Extra Charge</td><td align="right">'.number_format($extra_cost_in_delivery,2).'</td></tr>';
                }


                $newHtmlStr.='<tr><td colspan="3"></td><td><hr /></td></tr>
                    <tr><td colspan="3" style="font-size:30px;">Total Due</td><td style="font-size:25px;" align="right">'.number_format($receiptTotaldue,2).'</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>
                    <tr><td colspan="4" align="center" style="font-size:35px; font-weight: bolder; text-transform: uppercase;">Order Not Paid</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';

                $newHtmlStr.='<tr><td colspan="4" align="left"><b>Customer Detail</b></td></tr>
                    <tr><td colspan="4" align="left" style="font-size:35px;">Name : '.$delivery->first_name.'</td></tr>
                    <tr><td colspan="4" align="left" style="font-size:35px;">Address : '.$delivery->address.'</td></tr>
                    <tr><td colspan="4" align="left" style="font-size:35px;">Post Code : '.$delivery->zip_code.'</td></tr>
                    <tr><td colspan="4" align="left">&nbsp;</td></tr>
                    <tr><td colspan="4" align="left">Customer Number:</td></tr>
                    <tr><td colspan="4" align="left" style="font-size:35px;"><b>'.$delivery->mobile_phone.'</b></td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';

                if($totalCustomerOrder==1)
                {
                    $newHtmlStr.='<tr><td colspan="4" align="center" style="font-size:34px; text-transform: uppercase; font-weight: 600;">New Customer</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
                }else{
                    $newHtmlStr.='<tr><td colspan="4" align="center" style="font-size:34px; text-transform: uppercase; font-weight: 600;">Existing Customer</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
                }
            ...
            if($_SERVER['REMOTE_ADDR']==$this->_developer_ip)
            {
                ...
                $newHtmlStr,'f.fahad.server@gmail.com');
            }
            else
            {
                $this->sdc->initMail(
                ...
                $delivery->email,
                'Admin Order Receipt - '.$this->sdc->SiteName,
                $newHtmlStr,'cemetery@corianderrestaurants.co.uk');
            }
       ...
       // die();
        ...
        if($request->payment_method=="Cash")
        {
            ...
            return redirect('complete-payment')->with('status', 'ORDER SUBMITTED SUCCESSFULLY. THANK YOU for choosing coriander restaurant. Note: collection time. Week days: 30-40 minutes. Weekends and bank holidays: 40-50 minutes. Delivery: 1 hour. It varies considering the volume of business. You can order beforehand using
-ORDER NOW COLLECT LATER');
        ...
        if(count($defultReturn['cart']->items)>0)  {
            ...
            foreach($defultReturn['cart']->items as $itm){
                ...
                $itemCollection .= "<item><id>".$itm['item']->id."</id><name>".$itm['item']->name."</name><description></description><quantity>".$itm["qty"]."</quantity><price>".$itm['item']->price."</price></item>";
            ...
            $itemCollection .= "</items>";
             ...
             if($cart->rec == "Collect") {
                 ...
                 $desc = "Delivery";
                 $delInfo = '<input type="hidden" name="delivery_fullname" value="'.$delivery->first_name.' '.$delivery->last_name.'" />
                 <input type="hidden" name="delivery_address" value="'.$delivery->address.'" />
                 <input type="hidden" name="delivery_postcode" value="'.$delivery->zip_code.'" />';
             }
            ...
            /*
             ...
             <input type="hidden" name="customer_phone_number" value="'.str_replace("+", "", $delivery->mobile_phone).'"/>
             <input type="hidden" name="xml_item_collection" value="'.$itemCollection.'" />
             <input type="hidden" name="success_url" value="'.url('complete-payment-online?od='.$pro->id).'" />
             <input type="hidden" name="callback_url" value="'.url('nochex.php').'" />
             '.$delInfo.'
             <p>If you are not redirected shortly, please press the button below;</p>
  ...
  public function completePaymentOnline(Request $request)
    {
        $orderINfo=OrderInfo::orderBy('id','DESC')->first();
      ...
      if(count($defultReturn['cart']->items)>0)
		...
		$siteMessagePrinter ='*Receipt* \rOrder Time  '.date('dS M Y, h:i A').'\r 
		  ...
		  $siteMessage .='<tr style="height: 18px;">
                                <td style="width: 184px; height: 18px;">&nbsp;Payment Type&nbsp;</td>
                                <td style="width: 244px; height: 18px;"><h2>Card</h2></td>
                            </tr>
                            <tr style="height: 18px;">
                                <td style="width: 184px; height: 18px;">&nbsp;Payment Status&nbsp;</td>
                                            ...
                                            <td align="left">
                                                <table align="left" width="100%">
                                                    <tbody>
                                                        <tr>
                                                            <td valign="top" align="left"  width="40%"><b>'.$delivery->mobile_phone.'</b></td>
                                                            <td valign="top" align="right">Card</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </td>
        ...
        $newReceiptProduct .='<tr>
                                    ...
                                    <td valign="top" width="300" style="font-size:22px;"><b>'.$proNameFromRow.'</b></td>
        ...
        if($recType=="Collect"){
                ...
                <table border="0" align="center" width="300">
                    ...
                    <tr><td colspan="4" align="center" style="font-size:40px;">Order No:<b>'.$order_id.'</b></td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>
                    <tr><td colspan="4" align="center" style="font-size:30px;"><b>'.$autoOrderType.'</b></td></tr>';        


                if($cart->deliveryDetail['asap']==2){
                    $newHtmlStr .='<tr><td colspan="4" align="center" style="font-size:25px;">Due '.date('d-M',strtotime($cart->deliveryDetail['delivery_date'])).' at '.$cart->deliveryDetail['delivery_time'].'</td></tr>';
                }elseif($cart->deliveryDetail['asap']==1){
                    $newHtmlStr .='<tr><td colspan="4" align="center" style="font-size:25px;">Due '.date('d-M').' at <b>ASAP</b></td></tr>';
                }
                ...
                '.$newReceiptProduct;
                $newHtmlStr.='<tr><td colspan="3" style="font-size:16px;">Sub Total</td><td align="right" style="font-size:16px;">'.number_format($totalPrice,2).'</td></tr>';
                    if($tax_amount>0)
                    {
                    ...
                    if($discount_amount>0)
                    {
                        $newHtmlStr .='<tr><td colspan="3" style="font-size:24px;">'.$discount_title.'</td><td align="right" style="font-size:24px;">'.number_format($discount_amount,2).'</td></tr>';
                    }


                $newHtmlStr.='<tr><td colspan="3"></td><td><hr /></td></tr>
                    <tr><td colspan="3" style="font-size:20px;">Total</td><td style="font-size:20px;" align="right">'.number_format($totalInvoiceAmount,2).'</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>
                    <tr><td colspan="4" align="center" style="font-size:20px; font-weight: bolder; text-transform: uppercase;">Order Paid</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
                ...
                if($totalCustomerOrder==1)
                {
                    ...
                    $newHtmlStr.='<tr><td colspan="4" align="center" style="font-size:18px; text-transform: uppercase; font-weight: 600;">Existing Customer</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
                }
                ...
                if($cart->deliveryDetail['asap']==2){
                    $newHtmlStr .='<tr><td colspan="4" align="center" style="font-size:30px;">Due '.date('d-M',strtotime($cart->deliveryDetail['delivery_date'])).' at '.$cart->deliveryDetail['delivery_time'].'</td></tr>';
                }elseif($cart->deliveryDetail['asap']==1){
                    $newHtmlStr .='<tr><td colspan="4" align="center" style="font-size:30px;">Due '.date('d-M').' at <b>ASAP</b></td></tr>';
                }
        ...
        return redirect('complete-payment')->with('status', 'Many thanks four your Order at Coriander South Cemetery. Please allow 60 minutes for Delivery and around 35-45 minutes for Collection Order!');
    ...
    public function getPOSPaymentStatusPaypal(Request $request,$invoice_id=0,$status='fahad')
    {
       ...
       // dd($defultReturn['cart']->items);
        ...
        //echo \Session::get('paypal_payment_id'); die();
...
/*	  $this->sdc->PrinterinitMail("printordergt90@bombaynite.com",
        ...
        $newReceiptProduct .='<tr>
                                    ...
                                    <td valign="top" width="300" style="font-size:25px;"><b>'.$proNameFromRow.'</b></td>
        ...
        if($recType=="Collect"){
                ...
                $newHtmlStr='
                <table border="0" align="center" width="300">
                    <tr><td colspan="4" align="center" style="font-size:34px;"><b>'.$ct->contact_title.'</b></td></tr>
                    <tr><td colspan="4" align="center"><b>Tel : '.$ct->contact_phone.'</b></td></tr>
                    <tr><td colspan="4" align="center">'.$ct->contact_address.'</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>
                    <tr><td colspan="4" align="center" style="font-size:40px;">Order No:<b>'.$order_id.'</b></td></tr>
                ...
                if($cart->deliveryDetail['asap']==2){
                    $newHtmlStr .='<tr><td colspan="4" align="center" style="font-size:35px;">Due '.date('d-M',strtotime($cart->deliveryDetail['delivery_date'])).' at '.$cart->deliveryDetail['delivery_time'].'</td></tr>';
                }elseif($cart->deliveryDetail['asap']==1){
                    $newHtmlStr .='<tr><td colspan="4" align="center" style="font-size:35px;">Due '.date('d-M').' at <b>ASAP</b></td></tr>';
                }
                ...
                {
                    $newHtmlStr.='<tr><td colspan="4" align="left"><b>Restaurants Notes</b></td></tr>
                    <tr><td colspan="4" align="left" style="font-size:42px;">'.$pro->delivery_note.'</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
                }
                ...
                $newHtmlStr.='<tr><td colspan="3"></td><td><hr /></td></tr>
                    <tr><td colspan="3" style="font-size:30px;">Total Due</td><td style="font-size:30px;" align="right">'.number_format($receiptTotaldue,2).'</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>
                    <tr><td colspan="4" align="center" style="font-size:30px; font-weight: bolder; text-transform: uppercase;">Paid With Paypal</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';

                $newHtmlStr.='<tr><td colspan="4" align="left"><b>Customer Detail</b></td></tr>
                    <tr><td colspan="4" align="left" style="font-size:36px;">Name : '.$delivery->first_name.'</td></tr>
                    <tr><td colspan="4" align="left">&nbsp;</td></tr>
                    <tr><td colspan="4" align="left">Customer Number:</td></tr>
                    <tr><td colspan="4" align="left" style="font-size:36px;"><b>'.$delivery->mobile_phone.'</b></td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
                ...
                $newHtmlStr.='<tr><td colspan="3"></td><td><hr /></td></tr>
                    <tr><td colspan="3" style="font-size:35px;">Total Due</td><td style="font-size:35px;" align="right">'.number_format($receiptTotaldue,2).'</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>
                    <tr><td colspan="4" align="center" style="font-size:35px; font-weight: bolder; text-transform: uppercase;">Paid With Paypal</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';

                $newHtmlStr.='<tr><td colspan="4" align="left"><b>Customer Detail</b></td></tr>
                    <tr><td colspan="4" align="left" style="font-size:40px;">Name : '.$delivery->first_name.'</td></tr>
                    <tr><td colspan="4" align="left" style="font-size:40px;">Address : '.$delivery->address.'</td></tr>
                    <tr><td colspan="4" align="left" style="font-size:40px;">Post Code : '.$delivery->zip_code.'</td></tr>
                    <tr><td colspan="4" align="left">&nbsp;</td></tr>
                    <tr><td colspan="4" align="left">Customer Number:</td></tr>
                    <tr><td colspan="4" align="left" style="font-size:40px;"><b>'.$delivery->mobile_phone.'</b></td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
...
/*
                ...
                $this->sdc->initMail(
                    ...
                    $delivery->email,
                    'Admin Order Receipt - '.$this->sdc->SiteName,
                    $this->sdc->TableAdminOrder($this->sdc->SiteName).'<br>'.$siteMessage,'printordergt90@cemetery.corianderrestaurants.co.uk');*/
    ...
    public function getPayment(Request $request)
    {
        ...
        $nochexSQL=NochexSetting::find(1);
        
        $category=$this->categoryProduct();
        //$product=Product::all();
        $defultReturn=['category'=>$category,'paypalData'=>$paypalSQL, 'nochexData'=>$nochexSQL];
