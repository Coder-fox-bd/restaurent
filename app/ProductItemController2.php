       ...
       if($request->payment_method=="Cash")
       {
        ...
        if($recType=="Collect"){
                ...
                <table border="0" align="center" width="300">
                    <tr><td colspan="4" align="center" style="font-size:30px;"><b>'.$ct->contact_title.'</b></td></tr>
                ...
                if($cart->deliveryDetail['asap']==2){
                    $newHtmlStr .='<tr><td colspan="4" align="center" style="font-size:24px;">Due '.date('d-M',strtotime($cart->deliveryDetail['delivery_date'])).' at '.$cart->deliveryDetail['delivery_time'].'</td></tr>';
                }elseif($cart->deliveryDetail['asap']==1){
                    $newHtmlStr .='<tr><td colspan="4" align="center" style="font-size:24px;">Due '.date('d-M').' at <b>ASAP</b></td></tr>';
                }
                ...
                if(!empty($pro->delivery_note))
                {
                    ...
                    <tr><td colspan="4" align="left" style="font-size:30px;">'.$pro->delivery_note.'</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
                }

            

                $newHtmlStr.='<tr><td></td><td></td><td></td><td align="right" style="font-size:25px;">GBP</td></tr>
                '.$newReceiptProduct;
                $newHtmlStr.='<tr><td colspan="3" style="font-size:20px;">Sub Total</td><td align="right" style="font-size:22px;">'.number_format($receiptTotal,2).'</td></tr>';
                    if($tax_amount>0)
                    {

                      $newHtmlStr .='<tr><td colspan="3" style="font-size:20px;">'.$tax_title.'</td><td align="right" style="font-size:20px;">'.number_format($tax_amount,2).'</td></tr>';

                    }

                    if($discount_amount>0)
                    {
                        $newHtmlStr .='<tr><td colspan="3" style="font-size:20px;">'.$discount_title.'</td><td align="right" style="font-size:24px;">'.number_format($discount_amount,2).'</td></tr>';
                    }


                $newHtmlStr.='<tr><td colspan="3"></td><td><hr /></td></tr>
                    <tr><td colspan="3" style="font-size:25px;">Total Due</td><td style="font-size:25px;" align="right">'.number_format($receiptTotaldue,2).'</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>
                    <tr><td colspan="4" align="center" style="font-size:30px; font-weight: bolder; text-transform: uppercase;">Order Not Paid</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
                ...
                {
                    $newHtmlStr.='<tr><td colspan="4" align="center" style="font-size:30px; text-transform: uppercase; font-weight: 600;">New Customer</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
                }else{
                    $newHtmlStr.='<tr><td colspan="4" align="center" style="font-size:30px; text-transform: uppercase; font-weight: 600;">Existing Customer</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
                }
                ...
                $newHtmlStr='
                    <table border="0" align="center" width="300">
                    <tr><td colspan="4" align="center" style="font-size:25px;"><b>'.$ct->contact_title.'</b></td></tr>
                    <tr><td colspan="4" align="center"><b>Tel : '.$ct->contact_phone.'</b></td></tr>
                    <tr><td colspan="4" align="center">'.$ct->contact_address.'</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>
                    <tr><td colspan="4" align="center" style="font-size:32px;">Order No:<b>'.$order_id.'</b></td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>
                    <tr><td colspan="4" align="center" style="font-size:32px;"><b>'.$autoOrderType.'</b></td></tr>';

                if($cart->deliveryDetail['asap']==2){
                    $newHtmlStr .='<tr><td colspan="4" align="center" style="font-size:22px;">Due '.date('d-M',strtotime($cart->deliveryDetail['delivery_date'])).' at '.$cart->deliveryDetail['delivery_time'].'</td></tr>';
                }elseif($cart->deliveryDetail['asap']==1){
                    $newHtmlStr .='<tr><td colspan="4" align="center" style="font-size:22px;">Due '.date('d-M').' at <b>ASAP</b></td></tr>';
                }
                ...
                {
                    $newHtmlStr.='<tr><td colspan="4" align="left"><b>Restaurants Notes</b></td></tr>
                    <tr><td colspan="4" align="left" style="font-size:25px;">'.$pro->delivery_note.'</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
                }
                ...
                $newHtmlStr.='<tr><td colspan="3" style="font-size:25px;">Sub Total</td><td align="right" style="font-size:25px;">'.number_format($receiptTotal,2).'</td></tr>';
                if($tax_amount>0)
                {
                  $newHtmlStr .='<tr><td colspan="3" style="font-size:25px;">'.$tax_title.'</td><td align="right" style="font-size:25px;">'.number_format($tax_amount,2).'</td></tr>';
                }

                if($discount_amount>0)
                {
                    $newHtmlStr .='<tr><td colspan="3" style="font-size:25px;">'.$discount_title.'</td><td align="right" style="font-size:25px;">'.number_format($discount_amount,2).'</td></tr>';
                }

                if($extra_cost_in_delivery>0)
                {
                    $newHtmlStr .='<tr><td colspan="3" style="font-size:20px;">Extra Charge</td><td align="right">'.number_format($extra_cost_in_delivery,2).'</td></tr>';
                }


                $newHtmlStr.='<tr><td colspan="3"></td><td><hr /></td></tr>
                    <tr><td colspan="3" style="font-size:20px;">Total Due</td><td style="font-size:25px;" align="right">'.number_format($receiptTotaldue,2).'</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>
                    <tr><td colspan="4" align="center" style="font-size:25px; font-weight: bolder; text-transform: uppercase;">Order Not Paid</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';

                $newHtmlStr.='<tr><td colspan="4" align="left"><b>Customer Detail</b></td></tr>
                    <tr><td colspan="4" align="left" style="font-size:25px;">Name : '.$delivery->first_name.'</td></tr>
                    <tr><td colspan="4" align="left" style="font-size:25px;">Address : '.$delivery->address.'</td></tr>
                    <tr><td colspan="4" align="left" style="font-size:25px;">Post Code : '.$delivery->zip_code.'</td></tr>
                    <tr><td colspan="4" align="left">&nbsp;</td></tr>
                    <tr><td colspan="4" align="left">Customer Number:</td></tr>
                    <tr><td colspan="4" align="left" style="font-size:25px;"><b>'.$delivery->mobile_phone.'</b></td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';

                if($totalCustomerOrder==1)
                {
                    $newHtmlStr.='<tr><td colspan="4" align="center" style="font-size:24px; text-transform: uppercase; font-weight: 600;">New Customer</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
                }else{
                    $newHtmlStr.='<tr><td colspan="4" align="center" style="font-size:24px; text-transform: uppercase; font-weight: 600;">Existing Customer</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
                }
...
/*	  $this->sdc->PrinterinitMail("printordergt90@bombaynite.com",
        ...
        if($recType=="Collect"){
                ...
                $newHtmlStr='
                <table border="0" align="center" width="300">
                    <tr><td colspan="4" align="center" style="font-size:24px;"><b>'.$ct->contact_title.'</b></td></tr>
                    <tr><td colspan="4" align="center"><b>Tel : '.$ct->contact_phone.'</b></td></tr>
                    <tr><td colspan="4" align="center">'.$ct->contact_address.'</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>
                    <tr><td colspan="4" align="center" style="font-size:40px;">Order No:<b>'.$order_id.'</b></td></tr>
                ...
                {
                    $newHtmlStr.='<tr><td colspan="4" align="left"><b>Restaurants Notes</b></td></tr>
                    <tr><td colspan="4" align="left" style="font-size:32px;">'.$pro->delivery_note.'</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
                }
                ...
                $newHtmlStr.='<tr><td colspan="4" align="left"><b>Customer Detail</b></td></tr>
                    <tr><td colspan="4" align="left" style="font-size:26px;">Name : '.$delivery->first_name.'</td></tr>
                    <tr><td colspan="4" align="left">&nbsp;</td></tr>
                    <tr><td colspan="4" align="left">Customer Number:</td></tr>
                    <tr><td colspan="4" align="left" style="font-size:26px;"><b>'.$delivery->mobile_phone.'</b></td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
                ...
                $newHtmlStr.='<tr><td colspan="3"></td><td><hr /></td></tr>
                    <tr><td colspan="3" style="font-size:25px;">Total Due</td><td style="font-size:25px;" align="right">'.number_format($receiptTotaldue,2).'</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>
                    <tr><td colspan="4" align="center" style="font-size:25px; font-weight: bolder; text-transform: uppercase;">Paid With Paypal</td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';

                $newHtmlStr.='<tr><td colspan="4" align="left"><b>Customer Detail</b></td></tr>
                    <tr><td colspan="4" align="left" style="font-size:30px;">Name : '.$delivery->first_name.'</td></tr>
                    <tr><td colspan="4" align="left" style="font-size:30px;">Address : '.$delivery->address.'</td></tr>
                    <tr><td colspan="4" align="left" style="font-size:30px;">Post Code : '.$delivery->zip_code.'</td></tr>
                    <tr><td colspan="4" align="left">&nbsp;</td></tr>
                    <tr><td colspan="4" align="left">Customer Number:</td></tr>
                    <tr><td colspan="4" align="left" style="font-size:30px;"><b>'.$delivery->mobile_phone.'</b></td></tr>
                    <tr><td colspan="4" align="center"><hr /></td></tr>';
