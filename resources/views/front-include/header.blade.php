...
<div class="header_bottom">
    <div class="container">
        <div id="header_logo">
            <a href="{{url('home')}}" title="Hi Choice home page 1"> <img class="logo img-responsive" src="{{url('upload/logo')}}/{{$seo[0]->site_logo}}" alt="Hi Choice home page 1" width="173" height="35" style="margin-top: -30px;" /> </a>
        </div>
