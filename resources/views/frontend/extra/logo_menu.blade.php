            ...
            <div class="cell-9 top-menu">
                ...
                <nav class="top-nav mega-menu">
                    <ul>
                        ...
                        <li class="{{ Request::path() == 'order-item' ? 'selected' : '' }}"><a href="{{url('order-item')}}"><i class="fa fa-cart-plus"></i><span>Online Order (S.Cemetery)</span></a>
                            @if(isset($mainmenu))
                            <ul>
                        ...
                        <li class="{{ Request::path() == 'our-offer' ? 'selected' : '' }}"><a href="{{url('our-offer')}}"><i class="fa fa-gift"></i><span>Offer</span></a></li>
                        <li class="{{ Request::path() == 'table-booking' ? 'selected' : '' }}"><a href="{{url('table-booking')}}"><i class="fa fa-cutlery"></i><span>Reservation</span></a></li>
                     ...
                     @if(count($otherExtraPage)>0)
                            <li class="{{ Request::path() == 'order-item' ? 'selected' : '' }}"><a href="javascript:void(0);"><i class="fa fa-info"></i><span>Menu</span></a>
                        ...
                        <li class="{{ Request::path() == 'contact-us' ? 'selected' : '' }}"><a href="{{url('contact-us')}}"><i class="fa fa-phone"></i><span>Contact</span></a></li>
                    </ul>
                </nav>
