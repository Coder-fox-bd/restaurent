...
@section('slider-js')
	<script type="text/javascript">
		...
		function calculateShoppingCartSummary()
		{
			...
			//console.log('Current Sub Total = ',total);
        ...
        console.log('Sub Total Before Discount = ',total);
        ...
        if(discount_rate && allowDiscount)
        {
        	...
        	if(discount_type)
        	{
                console.log('Sub Total after Discount type = ',total);
        		var limit_check=$(".top-shopping-cart-short").attr("data-disamount-limit");
                console.log('Discount type limit_check = ',limit_check);
