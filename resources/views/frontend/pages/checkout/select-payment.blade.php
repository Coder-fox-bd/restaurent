		...
		<div class="container">
			...
			<div class="row">
					...
					<div class="cell-4">
	                   ...
	                   <!--   <h3 class="panel-title uppercase" >If you want to Pay by Card, Please phone to the Restaurant. We are happy to take Card Payment over Phone. To complete the Order, Pls select Cash option & Submit</h3> -->
	                          <h3 class="panel-title uppercase" ></h3>
	                        </div>
	                            ...
	                            <ul class="form-style-1">
	                                <li style="padding-bottom: 20px;">
	                                    ...
	                                    <select name="payment_method" class="field-long">
	                                    	...
	                                    	@endif
	                                    	    @if($nochexData->nochex_status=="Active")
	                                    		<option value="Nochex">Credit / Debit Card (Nochex)</option>
	                                    		@endif 
