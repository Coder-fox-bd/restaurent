    ...
    <div class="limiter">
        <div class="container-login100 p-t-30 p-b-20" style="background-image: url('{{url('front-theme/images/restaurant.jpg')}}');">
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                ...
                <form class="login100-form validate-form" id="register_form" action="{{ url('/register') }}" method="post">
                    ...
                    <div style="border-bottom:0px; padding-top:15px;" class="wrap-input100 validate-input" style="padding-top: 20px;" data-validate="Confirm Password is required">
