...
//Nochex
Route::get('/nochex', 'OrderItemController@nochex');
Route::post('/nochex', 'OrderItemController@paywithnochex');
Route::get('/nochex/{status}', 'OrderItemController@getPaymentStatus');
...
Route::get('complete-payment-online','ProductItemController@completePaymentOnline');
...
Route::group(['middleware' => 'auth'], function () {
    //admin panel route
        ...
        //Nochex
        Route::get('admin-ecom/nochexsetting','NochexSettingController@index');
        Route::post('admin-ecom/nochexsetting-add','NochexSettingController@store');
        Route::post('admin-ecom/nochexsetting-update','NochexSettingController@update');
    //admin panel route
});